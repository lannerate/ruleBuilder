...
public class MemberPropertyToken extends MemberToken
  implements IStatementToken
{
  public MemberPropertyToken(MemberPropertyToken paramMemberPropertyToken)
  {
    super(paramMemberPropertyToken);
  }

  public MemberPropertyToken()
  {
  }

  public MemberPropertyToken(String paramString)
  {
    super(paramString);
  }
  ...
  {
    return new MemberPropertyToken(this);
  }
  ...
  public l[] getLeftPopupMenus()
  {
    List localList = a(e());
    this.b = null;
    Iterator localIterator = getEnvionment().getAcceptChildren(new e(this));
    Object localObject2;
    Object localObject3;
    while (localIterator.hasNext())
    {
      ...
      localList.add(localElementList1);
      this.b = null;
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        a(localTreeValueNode.getAcceptElements(new f(this)));
    ...
    Object localObject1 = new ArrayList(localList.size());
    for (int i = 0; i < localList.size(); i++)
      if ((localList.get(i) instanceof ElementList))
      {
        localObject2 = (ElementList)localList.get(i);
      ...
      {
        ((ArrayList)localObject1).add(new l(((IElement)localList.get(i)).getDisplayName(), new b(this, (IElement)localList.get(i)), (IElement)localList.get(i)));
      }
  ...
  {
    return getEnvionment().getAcceptElements(new g(this));
  }
  ...
  public boolean acceptBusinessObject(Object paramObject)
  {
    ...
    if (((paramObject instanceof IBusinessObjectEditen)) && (((IBusinessObjectEditen)paramObject).isEditVisible()))
    {
      ...
      if (((localIBusinessObjectEditen instanceof IVariableObject)) && ((str == null) || (str.length() == 0) || (localIBusinessObjectEditen.getJavaType().c(str))))
        return true;
    }
    return false;
  }

  public IVariableObject getVariableElement()
  {
    IElement localIElement = getMemberElement();
    if ((localIElement instanceof IVariableObject))
      return (IVariableObject)localIElement;
    return null;
  }

  public String getName()
  {
    return "MemberPropertyToken";
  }
 ...
 * Qualified Name:     com.flagleader.repository.rlm.value.MemberPropertyToken
