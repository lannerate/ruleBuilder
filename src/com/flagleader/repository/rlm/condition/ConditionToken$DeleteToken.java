...
public class ConditionToken$DeleteToken extends DeleteModifyToken
  implements IModifierEditen
{
  public ConditionToken$DeleteToken(ConditionToken paramConditionToken, String paramString, k paramk)
  {
 ...
 * Qualified Name:     com.flagleader.repository.rlm.condition.ConditionToken.DeleteToken
