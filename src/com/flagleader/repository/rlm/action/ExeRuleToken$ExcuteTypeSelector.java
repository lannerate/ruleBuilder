...
public class ExeRuleToken$ExcuteTypeSelector extends AbstractRuleObject
  implements ISelectorEditen
{
  public ExeRuleToken$ExcuteTypeSelector(ExeRuleToken paramExeRuleToken)
  {
  }

  public ExeRuleToken$ExcuteTypeSelector(ExeRuleToken paramExeRuleToken, ExcuteTypeSelector paramExcuteTypeSelector)
  {
    super(paramExcuteTypeSelector);
  }

  public ExeRuleToken$ExcuteTypeSelector(ExeRuleToken paramExeRuleToken, String paramString)
  {
  ...
  {
    return getLocalString(ExeRuleToken.access$0()[this.this$0.getReturnType()].substring(1) + ".edit", ExeRuleToken.access$0()[this.this$0.getReturnType()].substring(1));
  }
 ...
 * Qualified Name:     com.flagleader.repository.rlm.action.ExeRuleToken.ExcuteTypeSelector
