...
public class TestCaseLib extends AbstractPackageElement
  implements ao
{
  public static final String NAME = "TestCaseLib";
  public static final String DISPLAYNAME = getLocalString("TestCaseLib.text");
  public static final NodeInfo nodeInfo = new NodeInfo("TestCaseLib", DISPLAYNAME, DISPLAYNAME);
  ...
  private transient IRulePackage mainpack = null;
  CellStyle a;
  CellStyle b;
  int g;

  public TestCaseLib(TestCaseLib paramTestCaseLib)
  {
    super(paramTestCaseLib);
    this.initValues = paramTestCaseLib.initValues;
    this.willValues = paramTestCaseLib.willValues;
    this.excelFile = paramTestCaseLib.excelFile;
    this.ruleSetName = paramTestCaseLib.getRuleSetName();
  }

  public TestCaseLib(String paramString)
  {
    super(paramString);
  }
  ...
  {
    return paramRepositoryVisitor.visitTestCaseLib(this);
  }
  ...
  {
    return (paramIElement instanceof TestCase);
  }
  ...
  public boolean acceptNode(ITreeNode paramITreeNode)
  {
    if (b())
      return false;
    return (paramITreeNode instanceof TestCase);
  }
  ...
  public boolean acceptNode(String paramString)
  {
    if (b())
      return false;
    return (paramString.equals("TestCase")) || (paramString.equals("ExportModel"));
  }
  ...
  {
    Object localObject;
    if (paramString.equalsIgnoreCase("TestCase"))
    {
      localObject = new TestCase(getChildDefaultName(TestCase.DISPLAYNAME));
  ...
  public Iterator getAcceptNodes()
  {
    ...
    localArrayList.add(TestCase.nodeInfo);
  ...
  public IRulePackage getMainPackage()
  {
    ...
    if ((this.mainpack == null) && (getRepository() != null))
    {
      Iterator localIterator = getRepository().getAcceptElements(new aC(this));
      if (localIterator.hasNext())
        this.mainpack = ((IRulePackage)localIterator.next());
    }
    return this.mainpack;
  }

  public Map getCheckRuleName()
  {
    IRulePackage localIRulePackage = getMainPackage();
    if (localIRulePackage != null)
    {
      LinkedHashMap localLinkedHashMap = new LinkedHashMap();
      if (localIRulePackage.needCheckSubRule())
        localLinkedHashMap.put(localIRulePackage.getDisplayName(), Integer.valueOf(localIRulePackage.getChecktype()));
      Iterator localIterator = localIRulePackage.getAcceptElements(new aD(this));
      while (localIterator.hasNext())
      {
        IRuleSet localIRuleSet = (IRuleSet)localIterator.next();
        localLinkedHashMap.put(localIRuleSet.getDisplayName(), Integer.valueOf(localIRuleSet.getChecktype()));
      }
  ...
  public String getRuleSetName()
  {
    if (getMainPackage() != null)
    {
      this.ruleSetName = getMainPackage().getExeRulePackageName();
  ...
  private Workbook a(String[] paramArrayOfString, Workbook paramWorkbook)
  {
    ...
    this.b = paramWorkbook.createCellStyle();
    localFont.setColor(IndexedColors.RED.getIndex());
    this.b.setFont(localFont);
  ...
  private void a(Workbook paramWorkbook, int paramInt, String[] paramArrayOfString)
  {
    ...
    if (paramInt == 0)
      localSheet = paramWorkbook.createSheet(getLocalString("testcaseinit.text"));
    else if (paramInt == 1)
      localSheet = paramWorkbook.createSheet(getLocalString("testcasewill.text"));
    else if (paramInt == 2)
      localSheet = paramWorkbook.createSheet(getLocalString("testcaseresult.text"));
    this.g = 0;
    Row localRow = localSheet.createRow(this.g++);
    Font localFont = paramWorkbook.createFont();
  ...
  {
    Row localRow = paramSheet.createRow(this.g++);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!localTestObjectInfo.isOutVariable()) || (!localTestObjectInfo.isChanged()))
        continue;
      localCell.setCellStyle(this.b);
    }
  }

  public void setRuleSetName(String paramString)
  {
    this.ruleSetName = paramString;
    this.mainpack = null;
  }
  ...
  public boolean isNeedSave()
  {
    if (isModified())
      return true;
    if ((!(getParent() instanceof IRulePackage)) && (getProject() != null))
      return !new File(getProject().getTestDir() + File.separator + getFilePathName()).exists();
    return false;
  }

  public String getFilePathName()
  {
    return getDisplayName() + getRuleSetName() + ".test";
  }
}

/* Location:           D:\Dev_tools\ruleEngine\rbuilder.jar
 * Qualified Name:     com.flagleader.repository.tree.TestCaseLib
