...
public class f extends WizardPage
{
  ...
  public f(j paramj)
  {
    super("ReplaceMethodPage3");
    setTitle(a("title.ReplaceMethodPage3"));
    setDescription(a("describe.ReplaceMethodPage3"));
  }
  ...
  public void createControl(Composite paramComposite)
  {
    ...
    this.c = locali.a(localComposite, ".ReplaceMethodPage3", 68352);
  ...
  private String a(Object paramObject)
  {
    ...
    if ((paramObject instanceof IBusinessObjectEditen))
      return ((IBusinessObjectEditen)paramObject).getDisplayName();
    return "";
  }
  ...
  private String b(Object paramObject)
  {
    ...
    if ((paramObject instanceof IBusinessObjectEditen))
      return ((IBusinessObjectEditen)paramObject).getShowDisplayName();
    return "";
  }
  ...
  private String c(Object paramObject)
  {
    ...
    if ((paramObject instanceof IBusinessObjectEditen))
      return ((IBusinessObjectEditen)paramObject).getValueType();
    return "";
  }
  ...
  private void b()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        localTableItem.setText(0, ((IBusinessObjectEditen)localObject1).getShowDisplayName());
        localTableItem.setText(1, ((IBusinessObjectEditen)localObject1).getValueType());
        localTableItem.setText(2, ((IBusinessObjectEditen)localObject1).getValueName());
      }
      ...
      if (this.a.get(localObject1) != null)
      {
        ...
        if ((localObject2 instanceof IBusinessObjectEditen))
          localTableItem.setText(3, ((IBusinessObjectEditen)localObject2).getShowDisplayName());
 ...
 * Qualified Name:     com.flagleader.builder.e.g.f
