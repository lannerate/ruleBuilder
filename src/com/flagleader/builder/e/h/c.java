...
public class c extends WizardPage
{
  ...
  public c(j paramj)
  {
    super("ReplaceVariablePage2");
    setTitle(a("title.ReplaceVariablePage2"));
    setDescription(a("describe.ReplaceVariablePage2"));
    this.a = paramj;
  }
  ...
  public void createControl(Composite paramComposite)
  {
    ...
    this.b = new s().a(localComposite, ".ReplaceVariablePage2", 68386);
 ...
 * Qualified Name:     com.flagleader.builder.e.h.c
