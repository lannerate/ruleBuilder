...
public class h extends WizardPage
{
  ...
  private void a(TableItem paramTableItem, int paramInt)
  {
    ...
    localCCombo.addFocusListener(new j(this, localCCombo, paramTableItem));
    localCCombo.addTraverseListener(new k(this, localCCombo, paramTableItem));
 ...
 * Qualified Name:     com.flagleader.builder.e.f.h
