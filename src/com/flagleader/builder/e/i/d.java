...
public class d extends WizardPage
{
  ...
  {
    super("SelectField");
    setTitle(a("title.SelectFieldPage"));
    setDescription(a("describe.SelectFieldPage"));
  }
  ...
  public void createControl(Composite paramComposite)
  {
    ...
    this.a = new Tree(localComposite, 67618);
    this.a.setLayoutData(new GridData(1808));
    this.a.setHeaderVisible(true);
    this.a.setLinesVisible(true);
    String[] arrayOfString1 = ResourceTools.getStringArray("columns.SelectFieldPage");
    while (this.a.getColumnCount() > 0)
      this.a.getColumn(0).dispose();
    String[] arrayOfString2 = new String[arrayOfString1.length];
    for (int i = 0; i < arrayOfString1.length; i++)
      arrayOfString2[i] = ResourceTools.getMessage(arrayOfString1[i] + ".SelectFieldPage");
    ...
    this.a.setLayoutData(new GridData(1808));
    this.a.addSelectionListener(new e(this));
    setControl(localComposite);
  }

  private void a(ISelectObject paramISelectObject)
  {
    TreeItem localTreeItem1 = new TreeItem(this.a, 0);
  ...
  public List a()
  {
    ...
    TreeItem[] arrayOfTreeItem1 = this.a.getItems();
 ...
 * Qualified Name:     com.flagleader.builder.e.i.d
