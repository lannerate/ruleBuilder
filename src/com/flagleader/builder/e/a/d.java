...
public class d extends WizardPage
{
  ...
  public d(k paramk)
  {
    super("AssignVariablePage2");
    setTitle(a("title.AssignVariablePage2"));
    setDescription(a("describe.AssignVariablePage2"));
    this.a = paramk;
  }
  ...
  public void createControl(Composite paramComposite)
  {
    ...
    this.b = new s().a(localComposite, ".AssignVariablePage2", 68386);
    Iterator localIterator = this.a.a().getEnvionment().getAcceptElements(new e(this));
    ...
    this.b.addSelectionListener(new f(this));
 ...
 * Qualified Name:     com.flagleader.builder.e.a.d
