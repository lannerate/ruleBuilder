...
public class d extends WizardPage
{
  ...
  {
    super("SelectTable");
    setTitle(a("title.DeleteSelectTablePage"));
    setDescription(a("describe.DeleteSelectTablePage"));
    this.a = parama;
    this.e = parama.a().getTables();
  }
 ...
 * Qualified Name:     com.flagleader.builder.e.b.d
