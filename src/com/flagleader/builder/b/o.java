...
public class o extends r
{
  ...
  private o(Shell paramShell)
  {
    super(paramShell);
  }

  public o(Shell paramShell, BuilderManager paramBuilderManager, IRuleContainer paramIRuleContainer)
  {
    this(paramShell);
  ...
  {
    super.setMessage(a("title.LogConditionDialog"));
 ...
 * Qualified Name:     com.flagleader.builder.b.o
