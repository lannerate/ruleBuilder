...
import com.flagleader.builder.a.f.bl;
...
{
  private IRuleObject a;
  private Text b;
  private BuilderManager c;

  private b(Shell paramShell)
  {
    super(paramShell);
  }

  public b(Shell paramShell, BuilderManager paramBuilderManager, IRuleObject paramIRuleObject)
  {
    this(paramShell);
    this.c = paramBuilderManager;
    this.a = paramIRuleObject;
  }
  ...
  protected void c(Composite paramComposite)
  {
    ...
    new bl(this.a, localComposite, this.c.getRuleEditor()).update();
  }
 ...
 * Qualified Name:     com.flagleader.builder.b.b
