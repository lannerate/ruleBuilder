...
{
  private DecisionRelateRule a;
  private Text b;
  private BuilderManager c;

  private f(Shell paramShell)
  {
    super(paramShell);
  }

  public f(Shell paramShell, BuilderManager paramBuilderManager, DecisionRelateRule paramDecisionRelateRule)
  {
    this(paramShell);
    this.c = paramBuilderManager;
    this.a = paramDecisionRelateRule;
  }
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    localComposite2.setLayoutData(a(500, 300));
    c(localComposite2);
    return localComposite1;
  }
 ...
 * Qualified Name:     com.flagleader.builder.b.f
