...
import com.flagleader.builder.dialogs.e.as;
...
{
  f(b paramb, Label paramLabel, ISheetAndWhereEditen paramISheetAndWhereEditen1, ISheetAndWhereEditen paramISheetAndWhereEditen2)
  {
  }
  ...
  public void mouseDown(MouseEvent paramMouseEvent)
  {
    ...
    if (paramMouseEvent.button == 1)
    {
      ...
      localObject2 = new as((Shell)localObject1, this.c, this.a.b);
      if (((as)localObject2).open() == 0)
      {
    ...
    else
    {
      ...
      if ((localObject2 != null) && ((localObject2 instanceof ITreeNode)))
      {
        ...
        localMenuItem.addListener(13, new g(this, localITreeNode));
      }
 ...
 * Qualified Name:     com.flagleader.builder.a.f
