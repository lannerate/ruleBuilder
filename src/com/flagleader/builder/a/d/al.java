  ...
  implements IElementViewer
{
  ...
  public al(IPage paramIPage, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new al((ExportModel)this.c, paramComposite, this.a);
  }
  ...
  private void f()
  {
    ...
    if (a().getConfigManager().d().length() > 0)
    {
      ...
      str2 = str2.substring(0, 1).toUpperCase() + str2.substring(1) + "Form.java";
  ...
  {
    am localam = new am(this, paramBoolean);
    a(localam, true);
    localam.start();
  }
  ...
  {
    this.f.getDisplay().asyncExec(new an(this, paramString));
  }

  private void a(d paramd, Exception paramException)
  {
    this.f.getDisplay().asyncExec(new ao(this, paramd, paramException));
  }

  public String getCompositeUuid()
  {
    return e().getEditUuid() + "form";
  }
}
