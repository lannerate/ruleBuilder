  ...
  implements IElementViewer
{
  ...
  public C(IPage paramIPage, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new C((IPage)this.c, paramComposite, this.a);
  }
  ...
  private void f()
  {
    ...
    if (a().getConfigManager().d().length() > 0)
    {
      ...
      str2 = str2.substring(0, 1).toUpperCase() + str2.substring(1) + "Action.java";
  ...
  {
    this.f.getDisplay().asyncExec(new E(this, paramString));
  }

  private void a(d paramd, Exception paramException)
  {
    this.f.getDisplay().asyncExec(new F(this, paramd, paramException));
  }

  public String getCompositeUuid()
  {
    return e().getEditUuid() + "action";
  }
}
