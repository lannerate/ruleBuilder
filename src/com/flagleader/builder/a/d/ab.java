...
class ab
  implements Listener
{
  ab(W paramW, Item[] paramArrayOfItem)
  {
  }
    ...
    if (str1 != null)
    {
      ...
      try
      {
        ...
        if (localWizardDialog.open() == 0)
        {
          ...
          for (int i = 0; i < localc.g().size(); i++)
          {
            e locale = (e)localc.g().get(i);
            ((PageFieldModel)this.b[0].getData()).setPropertyValue("columns_" + locale.h(), locale.e());
          }
 ...
 * Qualified Name:     com.flagleader.builder.a.d.ab
