...
import com.flagleader.builder.dialogs.e.bS;
...
{
  l(b paramb, Label paramLabel, ISheetWhereEditen paramISheetWhereEditen1, ISheetWhereEditen paramISheetWhereEditen2)
  {
  }
  ...
  public void mouseDown(MouseEvent paramMouseEvent)
  {
    ...
    if (paramMouseEvent.button == 1)
    {
      ...
      localObject2 = new bS((Shell)localObject1, this.c, this.a.b);
      if (((bS)localObject2).open() == 0)
      {
    ...
    else
    {
      ...
      if ((localObject2 != null) && ((localObject2 instanceof ITreeNode)))
      {
        ...
        localMenuItem.addListener(13, new m(this, localITreeNode));
      }
 ...
 * Qualified Name:     com.flagleader.builder.a.l
