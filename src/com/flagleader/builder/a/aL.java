...
public abstract class aL extends aS
  implements bq
{
  protected af e;
  protected String f = "";

  public aL(ITreeNode paramITreeNode, Composite paramComposite, bu parambu)
  {
  ...
  protected Control a(Composite paramComposite)
  {
    ...
    if (!b())
    {
      this.e.m().addFocusListener(new aM(this));
    }
    else
    {
      this.e.m().setEditable(false);
      this.e.m().addFocusListener(new aN(this));
    }
    return localComposite;
  }

  protected abstract af b(Composite paramComposite);
 ...
 * Qualified Name:     com.flagleader.builder.a.aL
