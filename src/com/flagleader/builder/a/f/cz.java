...
public class cz extends l
{
  ...
  public cz(ck paramck, e parame)
  {
    this(paramck, parame, null);
  }

  public cz(ck paramck, e parame, Object paramObject)
  {
    this(paramck, parame, 0, paramObject);
  }

  public cz(ck paramck, e parame, int paramInt, Object paramObject)
  {
  ...
  protected Control a(Composite paramComposite)
  {
    ...
    new bm((IMultiLineEditen)m(), localComposite2, ck.h(this.a)).update();
