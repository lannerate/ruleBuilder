...
public class aB extends l
{
  ...
  public aB(af paramaf, e parame)
  {
    this(paramaf, parame, null);
  }

  public aB(af paramaf, e parame, Object paramObject)
  {
    this(paramaf, parame, 0, paramObject);
  }

  public aB(af paramaf, e parame, int paramInt, Object paramObject)
  {
  ...
  protected Control a(Composite paramComposite)
  {
    ...
    new bl((IRuleObject)m(), localComposite2, af.f(this.a)).update();
