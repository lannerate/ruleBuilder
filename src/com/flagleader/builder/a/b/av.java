...
{
  public av(InterfaceContainer paramInterfaceContainer, Composite paramComposite, bu parambu)
  {
    super(paramInterfaceContainer, paramComposite, parambu);
  }

  protected aS e(Composite paramComposite)
  {
    return new av((InterfaceContainer)this.c, paramComposite, this.a);
  }
  ...
  protected InterfaceContainer F()
  {
    return (InterfaceContainer)this.c;
  }
  ...
  protected boolean a(IElement paramIElement, int paramInt, String paramString)
  {
    ...
    {
      K().initUndoable();
      if ((paramIElement instanceof BusinessObjectClass))
      {
        ((BusinessObjectClass)paramIElement).changeDisplayName(paramIElement.getDisplayName(), paramString);
        paramIElement.setDisplayName(paramString);
        K().setModified(true);
        K().takeSnapshot();
        ((BusinessObjectClass)paramIElement).update();
      }
      else
      {
        paramIElement.setDisplayName(paramString);
  ...
  protected void t()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((!(localObject instanceof IFunctionObject)) && (!(localObject instanceof BusinessObjectClass))) || ((b()) && (!((IBusinessObjectEditen)localObject).isVisible())))
        continue;
  ...
  protected void a(Item paramItem, IElement paramIElement)
  {
    if ((paramIElement instanceof IBusinessObjectEditen))
    {
      ...
      localIBusinessObjectEditen1.setObjectEditor(new aw(this, paramItem));
    }
    b(paramItem);
  }
 ...
 * Qualified Name:     com.flagleader.builder.a.b.av
