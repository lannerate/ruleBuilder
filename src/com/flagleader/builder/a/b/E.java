...
{
  public E(ClassContainer paramClassContainer, Composite paramComposite, bu parambu)
  {
    super(paramClassContainer, paramComposite, parambu);
  }

  protected aS e(Composite paramComposite)
  {
    return new E((ClassContainer)this.c, paramComposite, this.a);
  }
  ...
  protected ClassContainer F()
  {
    return (ClassContainer)this.c;
  }
  ...
  protected void a(Item paramItem, IElement paramIElement)
  {
    if ((paramIElement instanceof IBusinessObjectEditen))
    {
      ...
      localIBusinessObjectEditen1.setObjectEditor(new F(this, paramItem));
    }
    b(paramItem);
  }
