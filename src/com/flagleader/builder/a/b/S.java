...
{
  public S(ExcelXYSheetModel paramExcelXYSheetModel, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new S((ExcelXYSheetModel)this.c, paramComposite, this.a);
  }
  ...
  protected String[] E()
  {
    return ExcelColModel.DATETYPES;
  }
  ...
  protected boolean a(IElement paramIElement, int paramInt, String paramString)
  {
    if (paramIElement == null)
    {
      if ((K().canCreateEditen()) && (paramString.length() > 0))
        ...
        {
          K().initUndoable();
          ExcelColModel localExcelColModel = F().createColModel(paramString, "string", paramString);
  ...
  {
    if ((paramIElement instanceof ExcelColModel))
    {
      ExcelColModel localExcelColModel = (ExcelColModel)paramIElement;
      return new String[] { localExcelColModel.getValueName(), localExcelColModel.getValueType(), localExcelColModel.getDisplayName(), localExcelColModel.getShowGroupName(), localExcelColModel.getVarValue() };
    }
  ...
  protected void t()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!(localObject instanceof ExcelColModel)) || ((b()) && (!((IBusinessObjectEditen)localObject).isVisible())))
        continue;
  ...
  {
    if ((paramIBusinessObjectEditen instanceof ExcelColModel))
    {
      ...
      localMenuItem.addListener(13, new T(this, paramIBusinessObjectEditen));
  ...
  {
    return super.getCompositeUuid() + "col";
  }
}
