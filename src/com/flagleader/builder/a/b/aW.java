...
{
  public aW(XmlNode paramXmlNode, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new aW((XmlNode)this.c, paramComposite, this.a);
  }
  ...
  protected boolean a(IElement paramIElement, int paramInt, String paramString)
  {
    ...
    {
      K().initUndoable();
      if ((paramIElement instanceof XmlNode))
      {
        ((XmlNode)paramIElement).changeDisplayName(paramIElement.getDisplayName());
        paramIElement.setDisplayName(paramString);
        K().setModified(true);
        K().takeSnapshot();
        ((XmlNode)paramIElement).updateTree();
      }
      else
      {
        paramIElement.setDisplayName(paramString);
  ...
  protected void a(Item paramItem, IElement paramIElement)
  {
    if ((paramIElement instanceof IBusinessObjectEditen))
    {
      ...
      localIBusinessObjectEditen1.setObjectEditor(new aX(this, paramItem));
    }
  }
 ...
 * Qualified Name:     com.flagleader.builder.a.b.aW
