...
{
  public aP(TreeValueNode paramTreeValueNode, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new aP((TreeValueNode)this.c, paramComposite, this.a);
  }
  ...
  protected void a(Item paramItem, IElement paramIElement)
  {
    if ((paramIElement instanceof IBusinessObjectEditen))
    {
      ...
      localIBusinessObjectEditen1.setObjectEditor(new aQ(this, paramItem));
    }
  }
