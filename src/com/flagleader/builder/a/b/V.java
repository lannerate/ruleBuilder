...
{
  public V(IExcelObject paramIExcelObject, Composite paramComposite, bu parambu)
  {
    super(paramIExcelObject, paramComposite, parambu);
  }

  protected aS e(Composite paramComposite)
  {
    return new V((IExcelObject)this.c, paramComposite, this.a);
  }
  ...
  protected IExcelObject F()
  {
    return (IExcelObject)this.c;
  }
  ...
  protected void a(Item paramItem, IElement paramIElement)
  {
    if ((paramIElement instanceof IBusinessObjectEditen))
    {
      ...
      localIBusinessObjectEditen1.setObjectEditor(new W(this, paramItem));
    }
  }
