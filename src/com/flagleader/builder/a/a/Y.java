...
{
  public Y(SheetTable paramSheetTable, Composite paramComposite, bu parambu)
  {
  ...
  {
    return new Y((SheetTable)this.c, paramComposite, this.a);
  }
  ...
  protected void t()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((!(localObject instanceof IBusinessObjectEditen)) || ((localObject instanceof SheetFieldModel)) || ((b()) && (!((IBusinessObjectEditen)localObject).isVisible())))
        continue;
