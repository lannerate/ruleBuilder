...
class fD extends f
{
  ...
  public fD(SnapTraceViewer paramSnapTraceViewer)
  {
  ...
  public fD(SnapTraceViewer paramSnapTraceViewer, String paramString1, String paramString2)
  {
    super(Display.getCurrent().getActiveShell());
    this.d = paramString1;
    this.e = paramString2;
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.c.setItems(SnapTraceViewer.a(this.a));
