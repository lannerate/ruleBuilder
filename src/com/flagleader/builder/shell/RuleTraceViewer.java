...
public class RuleTraceViewer
{
  ...
  public RuleTraceViewer(IRuleLog paramIRuleLog, IRulePackage paramIRulePackage, BuilderManager paramBuilderManager)
  {
  ...
  public RuleTraceViewer(BuilderManager paramBuilderManager)
  {
    this.y = paramBuilderManager;
  }

  public RuleTraceViewer()
  {
  }
  ...
  void b()
  {
    ...
    localToolItem.addSelectionListener(new eS(this));
  ...
  void a(Display paramDisplay)
  {
    ...
    this.a.addShellListener(new eK(this));
  }
  ...
  public Composite a(Composite paramComposite)
  {
    ...
    this.p.addMouseListener(new eL(this));
  ...
  {
    RuleTraceViewer localRuleTraceViewer = new RuleTraceViewer();
    Shell localShell = localRuleTraceViewer.b(null);
  ...
  private void l()
  {
    if (this.n == null)
      return;
    if (this.n.getRuleName() != null)
    {
      this.w = e(this.n.getRuleName());
  ...
  void b(String paramString)
  {
    ...
    try
    {
      this.n = ((IRuleLog)SerializationUtils.deserialize(new FileInputStream(paramString)));
    }
    catch (Exception localException)
    {
 ...
 * Qualified Name:     com.flagleader.builder.shell.RuleTraceViewer
