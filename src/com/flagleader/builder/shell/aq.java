...
class aq extends f
{
  ...
  public aq(aa paramaa, GlobalMethod paramGlobalMethod)
  {
    super(Display.getCurrent().getActiveShell());
    this.g = paramGlobalMethod.getDisName();
    this.k = paramGlobalMethod.getReturnType();
    this.h = paramGlobalMethod.getFuncName();
    this.i = paramGlobalMethod.getTypeName();
    this.j = paramGlobalMethod.getFuncBody();
  }
