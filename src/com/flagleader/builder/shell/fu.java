...
class fu extends MouseAdapter
{
  fu(SnapTraceViewer paramSnapTraceViewer)
  {
  }
  ...
  public void mouseDoubleClick(MouseEvent paramMouseEvent)
  {
    ...
    TreeItem localTreeItem = SnapTraceViewer.d(this.a).getItem(localPoint);
    if (localTreeItem == null)
      return;
    int i = -1;
    for (int j = 0; j < SnapTraceViewer.d(this.a).getColumnCount() + 1; j++)
    {
      if (!localTreeItem.getBounds(j).contains(localPoint))
        continue;
      i = j;
    }
    if ((i == 0) && (SnapTraceViewer.e(this.a) != null) && ((localTreeItem.getData() instanceof IRuleLog)))
    {
      SnapTraceViewer.e(this.a).getProjectTree().b(((IRuleLog)localTreeItem.getData()).getRuleName());
    }
    else
    {
      Object localObject1;
 ...
 * Qualified Name:     com.flagleader.builder.shell.fu
