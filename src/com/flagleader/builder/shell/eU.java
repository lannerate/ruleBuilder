...
class eU extends f
{
  ...
  public eU(RuleTraceViewer paramRuleTraceViewer)
  {
  ...
  public eU(RuleTraceViewer paramRuleTraceViewer, String paramString1, String paramString2)
  {
    super(Display.getCurrent().getActiveShell());
    this.d = paramString1;
    this.e = paramString2;
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.c.setItems(RuleTraceViewer.a(this.a));
