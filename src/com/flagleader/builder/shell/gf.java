...
class gf extends SelectionAdapter
{
  gf(TestRuleServerDialog paramTestRuleServerDialog)
  {
  }
  ...
  public void widgetSelected(SelectionEvent paramSelectionEvent)
  {
    ...
    if ((i > -1) && (TestRuleServerDialog.c(this.a).getItemCount() > 1) && (i < TestRuleServerDialog.c(this.a).getItemCount() - 1))
    {
 ...
 * Qualified Name:     com.flagleader.builder.shell.gf
