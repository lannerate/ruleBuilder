...
public abstract class g extends Dialog
{
  ...
  protected Button a(Composite paramComposite, String paramString, int paramInt)
  {
    ...
    localButton.setText(b(paramString));
    return localButton;
  }
  ...
  protected Combo c(Composite paramComposite, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localCombo.setLayoutData(b(paramInt2));
    return localCombo;
  }

  protected Combo c(Composite paramComposite)
  {
  ...
  {
    if (getShell() != null)
      getShell().setText(a(paramString, paramString));
  }
}
