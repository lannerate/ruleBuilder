...
public class b extends f
{
  ...
  public b(ITreeNode paramITreeNode)
  {
    super(new Shell());
    this.r = paramITreeNode;
  }

  public b(Shell paramShell)
  {
    super(paramShell);
  }
  ...
  private void a(IElement paramIElement, ArrayList paramArrayList)
  {
    ...
    {
      a(((IRuleTree)paramIElement).getMainPackage(), paramArrayList);
    }
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.e.setText(ResourceTools.getMessage("variable.FindRuleDialog"));
    this.e.setSelection(true);
    this.g = new Button(localGroup, 16);
    this.g.setText(ResourceTools.getMessage("valuetype.FindRuleDialog"));
    this.g.setSelection(false);
    this.f = new Button(localGroup, 16);
    this.f.setText(ResourceTools.getMessage("display.FindRuleDialog"));
    this.f.setSelection(false);
    this.h = new Button(localGroup, 16);
    this.h.setText(ResourceTools.getMessage("valuejava.FindRuleDialog"));
 ...
 * Qualified Name:     com.flagleader.builder.dialogs.f.b
