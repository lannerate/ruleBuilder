...
public class c extends a
{
  ...
  public c(Shell paramShell, ExcelBookModel paramExcelBookModel)
  {
  ...
  {
    setMessage(a("title.AddExcelXYSheetDialog"));
  ...
  protected void d(Composite paramComposite)
  {
    ...
    a(localComposite).setText(a("colNameLine.AddExcelXYSheetDialog") + ":  ");
    this.k = a(localComposite, 2048, 380, 12);
    this.k.setText("1");
    a(localComposite).setText(a("startRowLine.AddExcelXYSheetDialog") + ":  ");
    this.l = a(localComposite, 2048, 380, 12);
    this.l.setText("2");
    a(localComposite).setText(a("startCol.AddExcelXYSheetDialog") + ":  ");
 ...
 * Qualified Name:     com.flagleader.builder.dialogs.c.c
