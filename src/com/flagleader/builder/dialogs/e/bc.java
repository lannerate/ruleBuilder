...
class bc extends f
{
  ...
  public bc(aK paramaK)
  {
    ...
    this.g = "";
    this.h = "and";
    this.i = aK.a(paramaK).getCanSelectSourceFields();
  }

  public bc(aK paramaK, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    super(Display.getCurrent().getActiveShell());
    this.f = paramString2;
    this.j = paramInt;
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.c.addSelectionListener(new bd(this));
    ...
    if (this.j >= 0)
    {
      ...
      this.d.setItems(aK.a(this.a).getTypeFunctions(this.k));
    }
    else
    {
