...
public class ch extends r
{
  ...
  public ch(BuilderManager paramBuilderManager, Map paramMap, Iterator paramIterator)
  {
    super(paramBuilderManager.getShell());
    this.g = paramBuilderManager;
    while (paramIterator.hasNext())
      this.c.add(paramIterator.next());
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.h.setLayoutData(new GridData(1808));
    e();
    this.e.addSelectionListener(new ci(this));
 ...
 * Qualified Name:     com.flagleader.builder.dialogs.e.ch
