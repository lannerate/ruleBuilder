...
class aI extends f
{
  ...
  public aI(as paramas)
  {
    ...
    this.g = "";
    this.h = "and";
    this.i = as.a(paramas).getCanSelectSourceFields();
  }

  public aI(as paramas, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    super(Display.getCurrent().getActiveShell());
    this.f = paramString2;
    this.j = paramInt;
  ...
  protected Control createDialogArea(Composite paramComposite)
  {
    ...
    this.c.addSelectionListener(new aJ(this));
    ...
    if (this.j >= 0)
    {
      ...
      this.d.setItems(as.a(this.a).getTypeFunctions(this.k));
    }
    else
    {
