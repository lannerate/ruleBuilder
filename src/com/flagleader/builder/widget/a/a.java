  ...
  implements LineStyleListener
{
  ...
  public static String[] t = { "规则集", "进入条件", "循环条件", "如果", "那么", "否则", "否则如果", "初始化", "规则集", "规则", "决策表", "并且", "或者", "float", "boolean", "double", "string", "long", "float", "int", "interface", "long", "{", "}", "native", "new", "null", "package", "private", "protected", "public", "return", "short", "static", "super", "switch", "synchronized", "this", "throw", "throws", "transient", "true", "try", "void", "volatile", "while" };
