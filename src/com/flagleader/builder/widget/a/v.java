...
public class v extends af
{
  ...
  public v(BuilderManager paramBuilderManager, Composite paramComposite, int paramInt)
  {
    super(paramBuilderManager, paramComposite, paramInt);
  }

  public v(Composite paramComposite, int paramInt)
  {
  ...
  protected StyledText a(Composite paramComposite, int paramInt)
  {
    ...
    localStyledText.addModifyListener(new w(this, localStyledText));
    localStyledText.addMouseListener(new x(this, localStyledText));
  ...
  protected Menu i()
  {
    ...
    localMenuItem.addSelectionListener(new y(this, localStyledText));
    ...
    if (localStyledText.getSelectionText().length() > 0)
    {
      ...
      localMenuItem.addSelectionListener(new z(this, localStyledText));
      localMenuItem = new MenuItem(localMenu, 8);
      localMenuItem.setText(ResourceTools.getMessage("copy.popup"));
      localMenuItem.addSelectionListener(new A(this, localStyledText));
      localMenuItem.setAccelerator(SWT.MOD1 + 67);
    }
    localMenuItem = new MenuItem(localMenu, 8);
    localMenuItem.setText(ResourceTools.getMessage("paste.popup"));
    localMenuItem.addSelectionListener(new B(this, localStyledText));
