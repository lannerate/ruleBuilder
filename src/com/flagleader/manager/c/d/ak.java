...
{
  public ak(com.flagleader.manager.c.c paramc, RuleSet paramRuleSet, r paramr)
  {
    super(paramc, paramRuleSet, paramr);
  }
  ...
  public void a()
  {
    ...
    a(com.flagleader.manager.d.c.b("edittable.dialog"), new am(this));
    ...
    if ((g().getExceptionType() == 1) || (g().getExceptionType() == 2))
    ...
    a(com.flagleader.manager.d.c.b("checkSubRuleType.RuleTreeProperties"), new al(this));
  ...
  public RuleSet g()
  {
    if ((d() != null) && ((d() instanceof RuleSet)))
      return (RuleSet)d();
    return null;
  }
}
 ...
 * Qualified Name:     com.flagleader.manager.c.d.ak
