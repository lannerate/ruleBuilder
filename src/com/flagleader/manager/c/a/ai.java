...
class ai extends d
{
  ...
  {
    return new ListIterator(ah.a(this.a).f().getDBModel().getDBTableFields(b.a(this.a.b(), paramString)));
  }

  public Iterator a()
  {
    return new ListIterator(ah.a(this.a).f().getDBModel().getDBTableNames());
  }
