...
public class K extends W
{
  ...
  public K(IElement paramIElement)
  {
    super(paramIElement);
  }

  public K(TestCase paramTestCase, Writer paramWriter)
  {
    super(paramTestCase);
    this.b = paramWriter;
    this.g = new L(this, paramTestCase);
  }

  protected void a(String paramString1, TestCase paramTestCase, String paramString2)
  {
    this.a.add(new H(paramString1, paramTestCase, paramString2));
    o().a("error : " + paramTestCase + " : " + paramString1);
  }
  ...
  protected void a(TestCase paramTestCase)
  {
    ...
    if (paramTestCase.getRuleSetName().length() > 0)
    {
      ...
      try
      {
        ...
        if (paramTestCase.getEnvionment() != null)
        {
          localObject4 = paramTestCase.getEnvionment().getAcceptElements(new M(this));
