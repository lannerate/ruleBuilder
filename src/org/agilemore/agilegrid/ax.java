...
public class ax
{
  ...
  {
    String str = paramString1 + '|' + ax.class.getName() + '|' + paramString2;
  ...
  public static Image a(Class paramClass, String paramString)
  {
  ...
  public static void a(CoolBar paramCoolBar)
  {
    ...
    for (int m = 0; m < arrayOfCoolItem.length; m++)
    {
      ...
      if (localCoolItem.getControl() != null)
        continue;
      localCoolItem.setControl(new ay(paramCoolBar, 0));
    }
 ...
 * Qualified Name:     org.agilemore.agilegrid.ax
